  ...
  return (
    <div className="flex h-screen w-full flex-col bg-black text-white">
      ...
      <div className="flex w-full flex-1 flex-row">
        ...
        {/* main content */}
        <div className="flex h-full w-full flex-1 flex-col overflow-y-hidden">
          <div className="w-full h-[calc(100vh-90px)] flex flex-col gap-6 items-center justify-center">
            <h1 className="text-3xl font-medium">What can I help with?</h1>
            <VanishInput />
          </div>
          <p className="text-5xl text-neutral-900">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas
            beatae voluptatem quae animi dicta vel obcaecati natus, est aliquid!
            Temporibus esse, nihil earum dolores explicabo cumque corporis nulla
            beatae dolorem.Lorem ipsum dolor sit amet, consectetur adipisicing
            elit. Quas beatae voluptatem quae animi dicta vel obcaecati natus,
            est aliquid! Temporibus esse, nihil earum dolores explicabo cumque
            corporis nulla beatae dolorem.Lorem ipsum dolor sit amet,
            consectetur adipisicing elit. Quas beatae voluptatem quae animi
            dicta vel obcaecati natus, est aliquid! Temporibus esse, nihil earum
            dolores explicabo cumque corporis nulla beatae dolorem.Lorem ipsum
            dolor sit amet, consectetur adipisicing elit. Quas beatae voluptatem
            quae animi dicta vel obcaecati natus, est aliquid! Temporibus esse,
            nihil earum dolores explicabo cumque corporis nulla beatae
            ...
            dolor sit amet, consectetur adipisicing elit. Quas beatae voluptatem
            quae animi dicta vel obcaecati natus, est aliquid! Temporibus esse,
            nihil earum dolores explicabo cumque corporis nulla beatae dolorem.
          </p>
